public class MainNilai {
    ...
    public static void main(String[] args) {
        ...
        HitungNilai h = new HitungNilai();

        int max = h.maxUTS(mhs, 0, mhs.length - 1);
        int min = h.minUTS(mhs, 0, mhs.length - 1);
        double rata = h.rataUAS(mhs);

        System.out.println("UTS tertinggi (DC) = " + max);
        System.out.println("UTS terendah (DC) = " + min);
